        ...
        <div>
            ...
            <Dialog open={open} onClose={handleClose} PaperProps={{ sx: { borderRadius: "8px", bgcolor: "#40414f" } }}>
                ...
                <DialogContent className='text-generation' sx={{ bgcolor: "#202123", color: "white", borderTop: "2px #0da37f solid", borderBottom: "2px #0da37f solid" }}>
                    <p>Made By <a className="link" style={{ padding: 0 }} href="https://kuldeep-portfolio.vercel.app">Kuldeep Sen &#8599;</a></p>
                    <p>Version : 1.0</p>
                    <p style={{ display: "flex" }}><LinkedInIcon sx={{ fill: "white" }} /><a className="link" style={{ padding: "1px", paddingTop: "2px" }} href="https://linkedin.com/in/kuldeep-sen134">LinkedIn Profile &#8599;</a></p>
                    <p style={{ display: "flex" }}><GitHubIcon sx={{ fill: "white" }} /><a className="link" style={{ padding: "1px", paddingTop: "2px" }} href="https://github.com/kuldeepsen134">GitHub Repository &#8599;</a></p>
                </DialogContent>
                ...
                <DialogContent className='text-generation' sx={{ bgcolor: "#202123", color: "white", borderTop: "2px #0da37f solid", borderBottom: "2px #0da37f solid" }}>
                    ...
                    <ul style={{ padding: 0, paddingLeft: "18px", listStyleType: "circle", color: "white" }}>
                        <li><strong>Version 1.0 (Latest Release)</strong>
